function createNav(dir) {
    var html = '<ul id="navbar">'+
                '<li class="logo">'+
                    '<a href="' + dir + '' + dir + 'index.html">'+
                        '<img src="' + dir + 'images/common_logo.png" alt="4PNT">'+
                    '</a>'+
                '</li>'+
                '<li>'+
                    '<a href="' + dir + '' + dir + 'index.html" class="nav-title">首页</a>'+
                '</li>'+
                '<li>'+
                        ...
                        '<ul class="subnav subnav-solution">'+
                            '<li class="default" style="margin-top:-30px;">'+
                                '<h2 class="nav-group-title"  style="padding-top:30px;">'+
                                    '<a href="' + dir + '' + dir + 'solutions/zhfw.html?page=a"><span class="iconfont icon-shengchanlian"></span>跨境电子商务</a>'+
                                '</h2>'+
                            ...
                            '</li>'+
                            '<li>'+
                                '<h2 class="nav-group-title"><a href="' + dir + '#"><span class="iconfont icon-unie63c"></span>内贸电子商务</a></h2>'+
                                '<div class="subnav-solution-content">'+
                            ...
                            '</li>'+
                            '<li>'+
                                '<h2 class="nav-group-title"><a href="' + dir + '#"><span class="iconfont icon-shiliangzhinengduixiang4"></span>智慧物流</a></h2>'+
                                '<div class="subnav-solution-content">'+
                ...
                '<li>'+
                    ...
                    '<span class="iconfont icon-tuolinglogo"></span>' +
                        '<ul class="subnav subnav-solution">'+
                            '<li class="default" style="margin-top:-30px;">'+
                                '<h2 class="nav-group-title"  style="padding-top:30px;">'+
                                    '<a href="' + dir + '' + dir + 'products/bcs.html"><span class="iconfont icon-gouwu"></span>电子商务商城系统</a>'+
                                '</h2>'+
                                '<div class="subnav-solution-content">'+
                                    '<a href="' + dir + '' + dir + 'products/bcs.html">B2C商城</a>'+
                                    '<a href="' + dir + '' + dir + 'products/bcs.html">B2B2C商城</a>'+
                                    '<a href="' + dir + '' + dir + 'products/bcs.html">B2B分销商城</a>'+
                                    '<a href="' + dir + '' + dir + 'products/bcs.html">跨境电商商城</a>' +
                                '</div>'+
                            '</li>'+
                            '<li>'+
                                '<h2 class="nav-group-title">'+
                                    '<a href="' + dir + '' + dir + 'products/erp.html"><span class="iconfont icon-gouwu"></span>电子商务运营管理系统产品套件</a>'+
                                '</h2>'+
                                '<div class="subnav-solution-content">'+
                                    '<a href="' + dir + '' + dir + 'products/erp.html?map=2">电子商务运营管理系统总览</a>'+
                                    '<a href="' + dir + '' + dir + 'products/erp.html?map=3">电商供应链管理系统</a>'+
                                    '<a href="' + dir + '' + dir + 'products/erp.html?map=4">电商物流仓配管理系统</a>'+
                                    '<a href="' + dir + '' + dir + 'products/erp.html?map=5">跨境电商物流头程集货管理系统</a>'+
                                    '<a href="' + dir + '' + dir + 'products/erp.html?map=6">跨境电商物流运输管理系统</a>'+
                                    '<a href="' + dir + '' + dir + 'products/erp.html?map=7">跨境电商关务管理系统</a>'+
                                    '<a href="' + dir + '' + dir + 'products/erp.html?map=8">费用核算与结算管理系统</a>'+
                                '</div>'+
                            '</li>'+
                            '<li>'+
                                '<h2 class="nav-group-title"><a href="' + dir + '' + dir + 'products/ewms.html"><span class="iconfont icon-shiliangzhinengduixiang4"></span>物流运营管理系统产品套件</a></h2>'+
                                '<div class="subnav-solution-content">'+
                                    '<a href="' + dir + '' + dir + 'products/ewms.html?map=2">物流运营管理系统总览</a>'+
                                    '<a href="' + dir + '' + dir + 'products/ewms.html?map=3">业务委托管理系统</a>'+
                                    '<a href="' + dir + '' + dir + 'products/ewms.html?map=4">物流计划管理系统</a>'+
                                    '<a href="' + dir + '' + dir + 'products/ewms.html?map=5">公路运输管理系统</a>'+
                                    '<a href="' + dir + '' + dir + 'products/ewms.html?map=6">仓库管理系统</a>'+
                                    '<a href="' + dir + '' + dir + 'products/ewms.html?map=7">海空铁运输管理系统</a>'+
                                    '<a href="' + dir + '' + dir + 'products/ewms.html?map=8">关务管理系统</a>'+
                                    '<a href="' + dir + '' + dir + 'products/ewms.html?map=9">车务管理系统</a>'+
                                    '<a href="' + dir + '' + dir + 'products/ewms.html?map=10">计费与结算管理系统</a>'+
                                '</div>'+
                            '</li>'+
                            '<li>'+
                                '<h2 class="nav-group-title"><a href="' + dir + '' + dir + 'products/wp918.html"><span class="iconfont icon-daibanyewu"></span>配套软硬件产品</a></h2>'+
                                '<div class="subnav-solution-content">'+
                                    '<a href="' + dir + '' + dir + 'products/wp918.html">移动手持数据终端</a>'+
                                    '<a href="' + dir + '#">蓝牙电子称</a>'+
                                '</div>'+
                            '</li>'+
                        '</ul>'+
                    ...
                    '<div class="subnav-wrapper wrapper-350">'+
                        '<ul class="subnav subnav-service clearfix">'+
                            ...
                            '<li>'+
                                ...
                                '<a href="' + dir + '' + dir + 'tuoling.html">驼铃云服务</a>'+
                ...
                '</li>'+
                '<li>'+
                    '<a href="' + dir + '' + dir + 'tuoling.html" class="nav-title">驼铃云</a>'+
                '</li>'+
                '<li>'+
                    '<a href="' + dir + '' + dir + 'aboutus.html" class="nav-title">关于我们</a>'+
                '</li> '+
            '</ul>';
